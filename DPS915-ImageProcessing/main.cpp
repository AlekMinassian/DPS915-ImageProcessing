    ...
    while(choice > 0 && choice <= 13)
    {
        ...
        switch(choice)
        {
            ...
            case 2: //enlarge image
				...
				te = steady_clock::now();
				auto msEnlarge = duration_cast<milliseconds>(te - ts);
				std::cout << "enlarge image took - " << msEnlarge.count() << " millisecs" << std::endl;
                writeImage(argv[2], image);
                break;
            case 3: // shrink image
                while(able == false)
            ...
            case 6: //rotate
				...
				std::cout << "rotate image took - " << ms.count() << " millisecs" << std::endl;
                writeImage(argv[2], image);
